...
/// <summary>
///     Provides abstraction for RaindropIO API operations to support both real API calls and dummy data for local
///     development.
/// </summary>
public interface IRaindropAPI
{
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a collection of video
    ///     RaindropItems.
    /// </returns>
    ...
    ///     Thrown when the API response cannot be processed or is in an unexpected
    ///     format.
    /// </exception>
    ...
    /// <param name="cancellationToken">Token to cancel the operation if needed.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains a collection of article
    ///     RaindropItems.
    /// </returns>
    /// <exception cref="HttpRequestException">Thrown when the API request fails due to network or server issues.</exception>
    /// <exception cref="TaskCanceledException">Thrown when the operation is cancelled via the cancellation token.</exception>
