...
- **`CONTEXT.md`** at the repo root — the domain language glossary
- **`docs/adr/`** — architecture decision records; read any that touch the
...
├── docs/
│   ├── adr/
│   │   ├── 0001-dummy-test-double-convention.md
│   │   └── ...
│   └── agents/
│       ├── issue-tracker.md
│       ├── triage-labels.md
...
> _Contradicts ADR-0001 (dummy test double convention) — but worth
> reopening because…_
