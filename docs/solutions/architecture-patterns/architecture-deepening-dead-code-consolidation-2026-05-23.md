...
**Verification**: ConfigureAwaitFixer end-to-end tested — fixes missing
`ConfigureAwait(false)`, leaves TUnit assertion chains untouched, no-op
on clean files, ~4s per file. (session history)
