...
Each is in `~/.config/opencode/agents/`. Model changes update one file, not twelve.
...
- `~/.config/opencode/agents/rm-brilliant-primary-agent.md`
- `~/.config/opencode/agents/rm-karpathy-universal-primary-agent.md`
- `~/.config/opencode/agents/rm-rigurous-verifier.md`
- `~/.config/opencode/agents/rm-rigurous-verifier-planmode.md`
