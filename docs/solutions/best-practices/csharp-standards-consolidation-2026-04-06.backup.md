...
**Status**: Consolidation in progress. After consolidation, duplicates will be identified and the user will decide what to delete. Then a final optimized version will be created.
...
Used in Blazor components for dependency injection:
