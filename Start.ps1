Push-Location "src/redmuffin.Blazor.StaticWeb.Api/"
    ...
    Start-Process -NoNewWindow powershell -ArgumentList "-Command dotnet watch run --port 7184"
Pop-Location

Push-Location "src/redmuffin.Blazor.StaticWeb/"
    Start-Process -NoNewWindow powershell -ArgumentList "-Command dotnet watch run"
Pop-Location
