...
public sealed partial class ExchangeRaindropCodeFunction_Tests
{
    ...
    /// <summary>
    ///     Test scope for ExchangeRaindropCodeFunction tests.
    ...
    public sealed class HttpRequestData_Mock : HttpRequestData, IDisposable
    {
        ...
        public HttpRequestData_Mock(FunctionContext functionContext, object? body = null) : base(functionContext)
        {
            if (body != null)
            {
                ...
                _bodyStream = new MemoryStream(Encoding.UTF8.GetBytes(json));
            }
            else
            {
        ...
        public override Uri Url => new("http://localhost/api/ExchangeRaindropCode");
    ...
    /// </summary>
    public sealed class HttpResponseData_Mock : HttpResponseData, IDisposable, IAsyncDisposable
    {
