...
public partial class CallApiExampleTests
{
    ...
    public class RaindropAPIMock : IRaindropAPI
    {
        ...
        public Task<IEnumerable<redmuffin.Blazor.StaticWeb.Common.Raindrop.RaindropItem>> GetVideosAsync(CancellationToken cancellationToken = default)
        {
            GetVideosAsyncCalled = true;
            return Task.FromResult(Enumerable.Empty<redmuffin.Blazor.StaticWeb.Common.Raindrop.RaindropItem>());
        }

        public Task<IEnumerable<redmuffin.Blazor.StaticWeb.Common.Raindrop.RaindropItem>> GetArticlesAsync(CancellationToken cancellationToken = default)
        {
