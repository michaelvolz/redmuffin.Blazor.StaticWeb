...
/// Contains utility functions for file system operations and path management.
/// </summary>
public partial class BlazorCodeBehindEnforcementTests
{
    ...
    private static IEnumerable<string> GetAllRazorFiles()
    {
        ...
        {
            throw new DirectoryNotFoundException($"Blazor project directory not found: {BlazorProjectPath}");
        }
