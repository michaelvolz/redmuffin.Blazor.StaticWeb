---
name: generate-tasks
description: Generating a task list from PRD. Use this skill when the user asks to create a task list, todo list, task breakdown, implementation plan from PRD, or mentions task list, todo from PRD, break down PRD, implementation tasks, task breakdown.
---
