---
name: rm-create-prd
description: "Shortcut: rm:prd. Product Requirements Document (PRD) generation. Use when asked to generate a PRD, write requirements, create a feature spec, or mentions PRD/requirements document."
---
