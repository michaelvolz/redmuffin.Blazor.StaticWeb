...
!`case "${CLAUDE_SKILL_DIR}" in */plugins/cache/*/compound-engineering/*/skillsskill({ name: "ce-update" })) basename "$(dirname "$(dirname "${CLAUDE_SKILL_DIR}")")" ;; *) echo '__CE_UPDATE_NOT_MARKETPLACE__' ;; esac`

**Marketplace name:**
!`case "${CLAUDE_SKILL_DIR}" in */plugins/cache/*/compound-engineering/*/skillsskill({ name: "ce-update" })) basename "$(dirname "$(dirname "$(dirname "$(dirname "${CLAUDE_SKILL_DIR}")")")")" ;; *) echo '__CE_UPDATE_NOT_MARKETPLACE__' ;; esac`
