...
## Stack-Specific Conditional (10 personas)
...
| `rm-dotnet-csharp`     | `rm-dotnet-csharp-reviewer`                                 | C# code, domain logic, public APIs, performance-sensitive paths, security-sensitive behavior, or maintainability-critical refactors              |
...
| `rm-uncle-bob-csharp`  | `rm-uncle-bob-csharp-reviewer`                              | C# code, architecture boundaries, dependency direction, testability, or craftsmanship-sensitive refactors                                        |
