...
- Requirements document → skill({ name: "ce-plan" })
- Plan document → skill({ name: "ce-work" })
...
- Do not modify caller skills (ce-brainstorm, ce-plan, or external plugin skills that invoke skill({ name: "ce-doc-review" }))
