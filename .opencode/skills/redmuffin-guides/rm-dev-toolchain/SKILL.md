...
description: "Dev toolchain reference — required tools, versions, cross-platform install, SCSS compilation, JS minification. Use when installing tools or troubleshooting missing executables."
---
