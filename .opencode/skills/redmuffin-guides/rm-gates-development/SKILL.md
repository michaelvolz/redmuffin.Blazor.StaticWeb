---
name: rm-gates-development
description: Quality gates toolchain conventions and operational rules for the tools/ solution. Use when editing tools/src/ or touching gate implementations.
---

# rm-gates-development
...
- `rm-architecture-uncle-bob` skill — Uncle Bob's full metric suite
- `rm-quality-gates` skill — cleanup workflows, survivor decision tree, Feathers extraction
- `rm-code-quality` skill — universal code quality rules, seam extraction gates
