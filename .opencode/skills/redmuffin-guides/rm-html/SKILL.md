---
name: rm-html
description: HTML standards, deprecated elements catalog, and 2026 best practices for semantics and accessibility. Use when writing or reviewing HTML or Razor markup.
---
...
See `rm-css` for CSS-specific standards and `rm-styling` for framework selection.
