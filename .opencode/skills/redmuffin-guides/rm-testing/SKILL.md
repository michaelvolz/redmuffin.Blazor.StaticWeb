---
name: rm-testing
description: ".NET 9 Blazor WASM and Azure Functions testing patterns — test doubles, TestScope, HttpClient fakes, JS interop stubs. Use when writing or reviewing tests."
---
...
See `rm-code-quality` §2.1 (I/O boundary injection example) and
...
- `.opencode/skills/redmuffin-guides/rm-naming/SKILL.md` —
  naming conventions for test doubles
- `.opencode/skills/redmuffin-guides/rm-code-quality/SKILL.md` —
