---
name: rm-roslyn-fixers
description: Auto-fix tool development for Roslyn analyzer diagnostics — MSBuildWorkspace architecture, diagnostic prioritization, extensible fixer scaffold. Use for adding code fixers. Never use for quality gates or general MSBuild.
---
...
- `rm-gates-development` — Quality gates toolchain conventions. Separate scope.
- `rm-warnings` — Analyzer warning policy, pragma decision tree.
- `rm-build-config` — Build commands, MSBuild conventions.
- `rm-async` — ConfigureAwait conventions and async patterns.
