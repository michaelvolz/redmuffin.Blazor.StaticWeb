...
name: rm-omarchy
description: >
  System packages (pacman/yay), dev runtimes (mise), supply chain
  security (sfw), and runtime guards. Use for package installs, updates,
  system maintenance, or supply chain configuration. Never use for
  desktop customization or general coding.
---
