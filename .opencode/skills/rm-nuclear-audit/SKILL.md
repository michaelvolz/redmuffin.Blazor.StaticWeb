---
name: rm-nuclear-audit
description: Full-solution thermo-nuclear code quality audit — workflow, batch orchestration, classification, and conflict resolution. Use for any full-solution audit.
---
