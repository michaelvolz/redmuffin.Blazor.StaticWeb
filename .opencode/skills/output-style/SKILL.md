---
name: output-style
description: C# formatting rules, naming conventions, output style constraints, C# 12/13 features, and nullable reference types. Use when writing or reviewing C# code, formatting files, naming types/variables, applying modern C# features, or handling nullable reference types.
invocable: false
---
