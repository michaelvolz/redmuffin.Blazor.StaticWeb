---
name: agent-markdown-optimizer
description: Transforms markdown instruction files into AI agent-optimized format. USE THIS SKILL when user explicitly requests agent optimization with phrases like "optimize for agents", "make agent-friendly", "compress for AI agents", "transform to agent format". Only processes .md and .mdc files. Human readability is irrelevant - output is for AI agents only.
---
