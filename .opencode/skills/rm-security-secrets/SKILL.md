---
name: rm-security-secrets
description: "Shortcut: rm:sec. Secret management, MCP env vars, and zero-tolerance security rules. Use when handling API keys, tokens, passwords, MCP secrets, environment variables, or any security-sensitive configuration."
---
