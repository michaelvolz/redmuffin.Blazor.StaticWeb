---
name: create-prd
description: Generating a Product Requirements Document (PRD). Use this skill when the user asks to generate a PRD, create a product requirements document, write a PRD for a new feature, or mentions PRD, requirements document, feature spec, product specification.
---
...
4.  **Save PRD:** Save the generated document as `prd-[number]-[feature-name].md` inside the `/tasks` directory.
