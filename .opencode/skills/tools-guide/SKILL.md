...
5. **Never mutate production code to kill a mutation survivor.** Only add
   ...
   Use the survivor decision tree in rm-gates-cleanup §4.
...
- `rm-uncle-bob-martin-agentic-coding` skill — Uncle Bob's full metric suite
- `rm-gates-cleanup` skill — cleanup workflows, survivor decision tree, Feathers extraction
