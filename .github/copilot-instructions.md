# Copilot Instructions (Streamlined General Rules)

This is the streamlined version of the main copilot instructions file, containing general, non-code-specific rules. For code-specific details, see the extracted section files (e.g., For Testing details, see copilot-instructions_testing.md; For C# coding standards, see copilot-instructions_csharp.md).
...
- **Testing Framework**: TUnit with `[Test]` and `[Arguments]`. NEVER use xUnit, NUnit, or MSTest. (See copilot-instructions_testing.md for details.)
...
- **Dependencies and Configuration**: See copilot-instructions_dotnet.md for details.
- **UI and Styling**: See copilot-instructions_uistyling.md for details.
...
- **Scripts**: `scripts/` for PowerShell automation. (See copilot-instructions_powershell.md for details.)
...
- **Coverage**: See copilot-instructions_powershell.md for details on coverage scripts and configuration.
