...
| SA1208/1210 | Order usings alphabetically (System first) |
| SA1201-1214 | Member order: fields?properties?constructors?methods, public?internal?protected?private |
...
### Known Warnings
**IL2111**: Safe to ignore (Blazor WebAssembly compilation in generated Razor files `App_razor.g.cs` - framework trimming optimization)
