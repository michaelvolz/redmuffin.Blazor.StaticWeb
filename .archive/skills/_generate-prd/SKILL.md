---
name: _generate-prd
description: Generating a Product Requirements Document (PRD) from an initial user prompt. Use this skill when the user asks to generate a PRD, create a product requirements document, or write a PRD for a new feature. Triggers on mentions of PRD, requirements document, feature spec, or product specification.
---
